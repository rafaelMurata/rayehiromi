package br.com.atelierrayehiromi.rayehiromi.dao;
...
public class EnviarEmail {
	 ...
	 * valor como string
	 */
	public EnviarEmail(String mailSMTPServer, String mailSMTPServerPort) { // Para outro
																	// Servidor
	...
	public void sendMail(String from, String to, String subject, String message) {
		...
		auth = new SimpleAuth("rafael.murata@gmail.com", "rfl1364");

		// Session - objeto que ira realizar a conex‹o com o servidor
		/*
		 * Como h‡ necessidade de autentica‹o Ž criada uma autenticacao que Ž
		 * responsavel por solicitar e retornar o usu‡rio e senha para
		 * autentica‹o
		 */
		Session session = Session.getDefaultInstance(props, auth);
		session.setDebug(true); // Habilita o LOG das a›es executadas durante o
								// envio do email

		// Objeto que contŽm a mensagem
		...
		try {
			...
			// Setando o conteœdo/corpo do email
		...
		try {
			 ...
			 * sua senha do gmail
			 */
			tr.connect(mailSMTPServer, "rafael.murata@gmail.com","rfl1364");
